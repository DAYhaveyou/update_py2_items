...
test_dir1 = '/home/liziqiang/PycharmProjects/untitled/test2'
...
message5 = ["10.25.10.249", "huacheng", "huacheng123", "LI_DataBase_test5"]

table0 = 'all_species_table_test1'
table2 = 'test_yaml_table'
table1 = 'test_names'

# fm.create_all_names(table0, message5)
# test_connect_database(message1)
# create_table('csv_table', message1)
# test_db.create_yaml_table(table2, message4)  # 1
# create_names_table(table1, table2, message4)  # 2
...
# get_raw_data(table0, test_dir1, table1, table2, message4)
...
# select_csv_to_database(table0, path, message5)
