...
def get_portfolio_bkt_csv_select_database(csv_dir, csv_array):
...
def test_unit0(dir_name, table, message):
    ...
    print len(raw_value)
    print raw_value
    call_it(dir_name, real_values)
    # get_portfolio_bkt_csv_select_database(dir_name, real_values)
    print 'success!'


def call_it(dir_name, table_array):
    name = get_portfolio_bkt_csv_select_database(dir_name, table_array)
    plot_portfolio_result(name)
    print "success!"
